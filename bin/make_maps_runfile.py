...
##
# This script were downloaded from https://raw.githubusercontent.com/ijuric/MAPS/18c1a337f222130d7c5735d051614e2a253d5319/bin/MAPS/make_maps_runfile.py
...
def init(parser):
    ...
    outstring = (
        "DATASET_NAME="
        + str(parser.DATASET_NAME)
        + "\n"
        + "OUT_DIR="
        + str(parser.OUT_DIR)
        + "\n"
        + "MACS2_PATH="
        + str(parser.MACS2_PATH)
        + "\n"
...
def main():
    ...
    parser.add_argument(
        "OUT_FILE_PATH",
        help="directory where .maps file will be stored. Must end with slash ",
    )
    ...
    parser.add_argument(
        "--PREPARE_TRANS",
        action="store_true",
        help="parepare counts for trans-interactions",
    )
